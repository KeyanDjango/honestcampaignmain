                ...
                <form>
                    ...
                    <div style={{ display: 'flex', columnGap: 10 }}>
                        ...
                        <span>
                            ...
                            <Input id='companyname' placeholder='Enter your Company name. E.g.,' className={Styles.input_text_signup} autoComplete='nope' autoCapitalize='off' autoCorrect='off' />
                        </span>
                    </div>
                    <label htmlFor='work_email'>Work email</label>
                    <Input id='work_email' placeholder='Enter your work email address. E.g.,bruce@wayne.enterprices' className={Styles.input_text_signup} autoComplete='nope' autoCapitalize='off' autoCorrect='off' />

                    <label htmlFor='sign_password'>Password</label>
                    <Input placeholder='Password' id='sign_password' className={Styles.input_text_signup} autoComplete='nope' autoCapitalize='off' autoCorrect='off' />
